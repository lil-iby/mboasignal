...
<head>
  ...
  <!-- Inclure le fichier CSS existant -->
...
<body>
  <main class="login-wrapper" role="main" aria-label="Formulaire de connexion">
    ...
    <div style="margin-top: 1.5rem; text-align: center; color: #d1d9e6; font-size: 0.9rem;">
      <p>Vous n'avez pas de compte ? <a href="{{ route('register') }}" style="color: #fff; font-weight: 600; text-decoration: none;">S'inscrire</a></p>
  ...
  <script>
    ...
    document.getElementById('login-form').addEventListener('submit', async function(e) {
      ...
      try {
        ...
        // Afficher l'erreur
        errorElement.textContent = error.message || 'Une erreur est survenue lors de la connexion';
